...
<head>
    ...
    <title>Job Portal Official</title>
        ...
        <div class="nav-bar">
            ...
            <div class="detail-nav">
                ...
                <div class="message-nav-bar bnb">
                    <button id="bh" class="button-style" onclick="alertLogin();">Messages</button>
                </div>
                <!-- message form popup -->
            ...
            <div class="profile-nav-bar">
                <div class="logo">
                    <img src="./Pictures/vijay2.jpg" alt="error" onclick="alertLogin();">  
                </div>
    ...
    <main>
        <div class="login-logout-register">
            <div class="choose-user">
                <form>
                    <button onclick="alertLogin();">Post Jobs</button>
                </form>
            </div>
            ...
            <div class="signup-login" <?php if(isset($_SESSION['success'])) {echo " style='display: none'"; } ?>>
                <div class="user-login" >
                    <a href="1login.php"><button>Login</button></a>
                </div>
                <div class="para-signup-login">
                    <pre><p style="font-size: 30px;"> Or </p></pre>
                </div>
                <div class="user-register-signup">
                    <a href="1register.php"><button>Register</button></a>
                </div>
            </div>
        </div>
                ...
                <div class="candidate-cornor-div">
                    ...
                    <div class="registration-candidate-id-link">
                        ...
                        <div class="extra-div-registration">
                             <p class="extra-div-registration-border">Registration Here</p>
